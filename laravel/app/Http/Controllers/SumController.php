...
class SumController extends Controller
{
    ...
    public function submitForm(Request $request)
    {
        ...
        if ($validator->fails()) {
            return redirect()
                ->route('sum-form')
                ->withErrors($validator) //persiduodam visas klaidas
                ->withInput(); //flashinimas, irasysim visus oldus
        }
        ...
        $request->flash();
        return redirect()->route('sum-form')->with('sum', $sum);
    }
}
